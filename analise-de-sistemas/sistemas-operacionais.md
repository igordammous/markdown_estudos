...
**Definição**: Escalonamento é o mecanismo pelo qual o sistema operacional decide qual processo/thread será executado pela CPU e por quanto tempo. O escalonador é ativado em quatro momentos principais:
